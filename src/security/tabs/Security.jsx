...
function Security({}) {
    ...
    return  (
        <div className='content f-col g52'>
            ...
            <div className='card f-row g32'>
                <div className='card p4'>
                    <img src={WebsiteImage} className='website-image' />
                </div>
                <div className='flex f-col g32'>
                    <div className='card f-col g24 p16'>
                    ...
                    <div className="card p16 f-col g36">
                        ...
                        <div className="f-col g32">
                            <div className="f-wrap f-row g32">
                                <div className="small-chart-wrap f-row g16">
                                    ...
                                    <SmallLineChart data={securityData.threatsBlocked}/>
                                </div>
                            </div>
                        </div>
                    </div>
